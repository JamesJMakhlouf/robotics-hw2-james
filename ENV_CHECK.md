# Homework 2 - Environment Check

```bash
james@james-pc:~$ colcon version-check
...
```bash
james@james-pc:~$ python3 --version
Python 3.12.3
```
...
```bash
james@james-pc:~$ printenv ROS_DISTRO
jazzy
```
...
```bash
james@james-pc:~$ timeout 3 ros2 run demo_nodes_cpp talker || echo "done"
[INFO] [1783262888.147034705] [talker]: Publishing: 'Hello World: 1'
[INFO] [1783262889.147038462] [talker]: Publishing: 'Hello World: 2'
[INFO] [1783262889.489673847] [rclcpp]: signal_handler(SIGINT/SIGTERM)
done
```